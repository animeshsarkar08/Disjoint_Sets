...
int main (int argc , char *argv[]){
	...
	dealloc(&start);
	//printf(" %d ",s);
	//printf("%d %d",start->left->left->value,start->left->right->value);
	printf("\n");
	/*hinsert(start,NULL,10);
	hinsert(start,NULL,30);
	hinsert(start,NULL,26);
	 //hinsert(start,NULL,40);
		 hinsert(start,NULL,11);
	//start = hinsert(start,NULL,8);
	//start = hinsert(start,NULL,9);*/
	return 0;
}
